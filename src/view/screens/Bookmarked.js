...
export default class Bookmarkedd extends React.Component {
  render() {
      ...
      <SafeAreaView
        ...
        <View style={styleBookmarkedd.BookmarkeddsContainer}>
          ...
          <View
            ...
            <View style={styleBookmarkedd.StatusTag}>
              <Text
                style={{
                  marginLeft: 15,
                  color: 'white',
          ...
          <View
            ...
            <View style={styleBookmarkedd.line} />
          ...
          <View style={styleBookmarkedd.comBot}>
            <View style={styleBookmarkedd.Btn}>
              <Text
...
const styleBookmarkedd = StyleSheet.create({
  header: {
